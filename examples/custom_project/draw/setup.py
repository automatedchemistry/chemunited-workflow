...
def build_draw(platform):
    ...
    platform.add_connection(
        ...
        diameter='1.0 millimeter',
        inflection_points=[[395.21337685388676, -726.9396937224842], [338.4165578519435, -730.4316672858515], [341.51814835097184, -551.1776540675351]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[492.0634928027231, -750.8631680141903], [321.49225092097254, -748.8934044317045], [321.7066299800973, -576.4085226404618]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[582.5877389499872, -763.8666642818391], [250.00437399460446, -760.6701525655291]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[670.4369616677546, -779.8532477418054], [209.02835025887742, -777.1384442955118]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[163.54550641037247, -798.5677534011651], [774.6102853635668, -802.186348923497]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[747.2240894555413, -178.59205225808728], [749.6318640620747, -18.502200081541275]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[913.5236618908236, -17.59141041663368], [911.2633339065383, -229.20644945135524]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[471.3090919777828, 124.49106694322154], [1065.948342275556, 123.34616851606046]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[854.4830560594255, -572.4704426855086], [760.9822013172164, -569.9518045941529]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[229.43175692378128, -208.59962114342216], [134.6884031818795, -206.48866862525773]],
        length='100.0 millimeter',
        straight_path=True,
    )
    ...
    platform.add_connection(
        ...
        classification='hydraulic',
        diameter='1.0 millimeter',
        inflection_points=[[1253.7077058553687, 159.85359306373033], [1253.2677624963885, 55.179754551145805]],
        length='100.0 millimeter',
        straight_path=True,
    )
